...
public class LibraryPackageImpl extends EPackageImpl implements LibraryPackage {
	 ...
	 * @generated
	 */
	public EReference getLibrary_Employes() {
	 ...
	 * @generated
	 */
	public EAttribute getEmploye_Age() {
	 ...
	 * @generated
	 */
	public EOperation getEmploye__DisplayEmp() {
	...
	public void createPackageContents() {
		...
		createEReference(libraryEClass, LIBRARY__EMPLOYES);
		...
		createEAttribute(employeEClass, EMPLOYE__AGE);
		createEOperation(employeEClass, EMPLOYE___DISPLAY_EMP);
	...
	public void initializePackageContents() {
		...
		initEReference(getLibrary_Employes(), this.getEmploye(), null, "employes", null, 0, -1, Library.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEmploye_Age(), ecorePackage.getEInt(), "age", "0", 0, 1, Employe.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEOperation(getEmploye__DisplayEmp(), ecorePackage.getEString(), "displayEmp", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getWriter_Books(), this.getBook(), this.getBook_Authors(), "books", null, 1, -1, Writer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getBook_Pages(), ecorePackage.getEInt(), "pages", "0", 0, 1, Book.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(bookCategoryEEnum, BookCategory.MISTERY);
